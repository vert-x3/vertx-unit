...
var HttpClient = function(j_val) {
  ...
  this.websocketAbs = function(url, headers, version, subProtocols, wsConnect, failureHandler) {
    ...
    if (__args.length === 6 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && __args[1]._jdel && typeof __args[2] === 'string' && typeof __args[3] === 'string' && typeof __args[4] === 'function' && typeof __args[5] === 'function') {
      j_httpClient["websocketAbs(java.lang.String,io.vertx.core.MultiMap,io.vertx.core.http.WebsocketVersion,java.lang.String,io.vertx.core.Handler,io.vertx.core.Handler)"](url, headers._jdel, io.vertx.core.http.WebsocketVersion.valueOf(version), subProtocols, function(jVal) {
  ...
  this.websocketStreamAbs = function(url, headers, version, subProtocols) {
    ...
    if (__args.length === 4 && typeof __args[0] === 'string' && typeof __args[1] === 'object' && __args[1]._jdel && typeof __args[2] === 'string' && typeof __args[3] === 'string') {
      return utils.convReturnVertxGen(ReadStream, j_httpClient["websocketStreamAbs(java.lang.String,io.vertx.core.MultiMap,io.vertx.core.http.WebsocketVersion,java.lang.String)"](url, headers._jdel, io.vertx.core.http.WebsocketVersion.valueOf(version), subProtocols), WebSocket._jtype);
    } else throw new TypeError('function invoked with invalid arguments');
  };
