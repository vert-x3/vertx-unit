...
var NetServer = function(j_val) {
  ...
  this.connectHandler = function(handler) {
    ...
    if (__args.length === 1 && (typeof __args[0] === 'function' || __args[0] == null)) {
      return utils.convReturnVertxGen(NetServer, j_netServer["connectHandler(io.vertx.core.Handler)"](handler == null ? null : function(jVal) {
  ...
  this.exceptionHandler = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_netServer["exceptionHandler(io.vertx.core.Handler)"](function(jVal) {
