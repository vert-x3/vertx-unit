...
WebSocketFrame.pingFrame = function(data) {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame["pingFrame(io.vertx.core.buffer.Buffer)"](data._jdel));
  } else throw new TypeError('function invoked with invalid arguments');
};
...
WebSocketFrame.pongFrame = function(data) {
  var __args = arguments;
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return utils.convReturnVertxGen(WebSocketFrame, JWebSocketFrame["pongFrame(io.vertx.core.buffer.Buffer)"](data._jdel));
  } else throw new TypeError('function invoked with invalid arguments');
};
