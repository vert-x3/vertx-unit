...
----
compile io.vertx:vertx-unit:3.1.0-SNAPSHOT
----
...
The test suite can also be run with a specified `link:../../vertx-core/groovy/groovydoc/io/vertx/groovy/core/Vertx.html[Vertx]` instance:
