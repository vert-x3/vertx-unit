...
Creating an `link:groovydoc/io/vertx/groovy/ext/unit/Async.html[Async]` object with the `link:groovydoc/io/vertx/groovy/ext/unit/Test.html#async()[async]` method marks the
...
The `TestCompletion` object provides also a `link:groovydoc/io/vertx/groovy/ext/unit/TestCompletion.html#resolve(io.vertx.core.Future)[resolve]` method that
...
with `link:groovydoc/io/vertx/groovy/ext/unit/Test.html[Test]` parameter are retained and mapped to a Vertx Unit test suite
via the method name:
