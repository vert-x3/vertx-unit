...
tested objects such as `link:../../vertx-core/groovy/groovydoc/io/vertx/groovy/core/Vertx.html[Vertx]` or an `link:../../vertx-core/groovy/groovydoc/io/vertx/groovy/core/http/HttpServer.html[HttpServer]`:
