...
The `link:yardoc/VertxUnit/TestContext.html#async_assert_success-instance_method[asyncAssertSuccess]` method returns an 
...
The `link:yardoc/VertxUnit/TestContext.html#async_assert_success-instance_method[asyncAssertSuccess]` method returns an 
instance that acts like `link:yardoc/VertxUnit/Async.html[Async]`, invoking the delegating  on success
...
The `link:yardoc/VertxUnit/TestContext.html#async_assert_failure-instance_method[asyncAssertFailure]` method returns an 
instance that acts like `link:yardoc/VertxUnit/Async.html[Async]`, resolving the `Async` on failure and failing the test
on success.

The `link:yardoc/VertxUnit/TestContext.html#async_assert_failure-instance_method[asyncAssertFailure]` method returns an 
instance that acts like `link:yardoc/VertxUnit/Async.html[Async]`, invoking the delegating  on failure
