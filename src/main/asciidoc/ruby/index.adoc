...
It is possible to wait until the completion of a specific `link:yardoc/VertxUnit/Async.html[Async]`:
...
The test suite can also be run with a specified `link:../../vertx-core/ruby/yardoc/Vertx/Vertx.html[Vertx]` instance:
