...
The `link:jsdoc/test_context-TestContext.html#asyncAssertSuccess[asyncAssertSuccess]` method returns an 
...
The `link:jsdoc/test_context-TestContext.html#asyncAssertSuccess[asyncAssertSuccess]` method returns an 
instance that acts like `link:jsdoc/async-Async.html[Async]`, invoking the delegating  on success
...
The `link:jsdoc/test_context-TestContext.html#asyncAssertFailure[asyncAssertFailure]` method returns an 
instance that acts like `link:jsdoc/async-Async.html[Async]`, resolving the `Async` on failure and failing the test
on success.

The `link:jsdoc/test_context-TestContext.html#asyncAssertFailure[asyncAssertFailure]` method returns an 
instance that acts like `link:jsdoc/async-Async.html[Async]`, invoking the delegating  on failure
