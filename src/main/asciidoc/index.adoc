...
The {@link io.vertx.ext.unit.TestContext#asyncAssertSuccess()} method returns an `Handler<AsyncResult<T>>`
...
The {@link io.vertx.ext.unit.TestContext#asyncAssertSuccess(io.vertx.core.Handler)} method returns an `Handler<AsyncResult<T>>`
